...
function applyRelease(ctx) {
  const { version, stagingVersion, targetSha, headRef, releaseNotes } = ctx;
...
async function main() {
  ...
  console.log(`[context] production_ancestor: ok  (origin/production is ancestor of target)`);
  ...
  // --apply: 実際に処理
  applyRelease({ version, stagingVersion, targetSha, headRef, releaseNotes });
}
